...
function renDerSP (mangSp) {
    ...
    for (var index= 0 ; index < mangSp.length;index++ ) {
        var sp = mangSp [index];
        htmlContent +=`
        <div style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;" id="sneaker" class="  rounded-2 mt-3  grow col-xl-2 col-md-3 col-sm-6 col-12"  onclick="window.location='./detail.html?productid=${sp.id}';">
